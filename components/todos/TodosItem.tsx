  ...
  return (
    <div>
      {todos.map((todo) => {
        ...
        return (
          <li key={id} className="flex px-4 w-[450px] py-[8px] ">
            <span className="flex gap-2 flex-1">
              ...
              <label
                htmlFor={id}
                className="peer-checked:line-through peer-checked:text-color-shade-1 cursor-pointer xl:text-[16px]  w-[150px] h-6"
              >
                {title}
              </label>
            </span>
